...
@section('content')
	<div id="contents">
		<div id="adbox">
			<div class="clearfix">
				<img src="{{asset('images/family-large.jpg') }}" alt="Img" height="382" width="956">
				<div class="detail" style="position: absolute;">
					<h1>Electronic Biometric <br> Voting System</h1>
					<p style="font-size: 16px;">An Advanced Approach to 
					Democracy in the 21st Century</p>
				</div>
			</div>
		</div>
		<div class="highlight">
		...
		<div class="featured">
			...
			<ul class="clearfix">
				<li>
					<div class="frame1">
						<div class="box">
							<img src="{{asset('images/meeting.jpg') }}" alt="Img" height="130" width="197">
						</div>
					</div>
					<p>
				...
				<li>
					<div class="frame1">
						<div class="box">
							<img src="{{asset('images/handshake.jpg') }}" alt="Img" height="130" width="197">
						</div>
					</div>
					<p>
				...
				<li>
					<div class="frame1">
						<div class="box">
							<img src="{{asset('images/smile.jpg') }}" alt="Img" height="130" width="197">
						</div>
					</div>
					<p>
				...
				<li>
					<div class="frame1">
						<div class="box">
							<img src="{{asset('images/family-small.jpg') }}" alt="Img" height="130" width="197">
						</div>
					</div>
					<p>
